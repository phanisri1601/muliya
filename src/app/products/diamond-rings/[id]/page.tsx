...
const diamondRings: Product[] = [
  {
    ...
    image: "/images/diamond/Rings.png",
    category: "Diamond Rings",
    description: "Elegant solitaire diamond ring with brilliant cut",
    weight: "6.2 grams",
    purity: "18K",
    details: ["VS Clarity Diamond", "F-G Color Grade", "Brilliant Cut", "IGI Certified"]
  },
  {
    id: "diamond-ring-002",
    ...
    weight: "7.5 grams",
    purity: "18K",
    details: ["Halo Setting", "Total 0.75 Carats", "Micro Pave Set", "Premium Quality"]
  },
  {
    id: "diamond-ring-003",
    ...
    weight: "6.8 grams",
    purity: "18K",
    details: ["Princess Cut", "Square Shape", "Modern Design", "High Polish"]
  },
  {
    id: "diamond-ring-004",
    ...
    weight: "8.2 grams",
    purity: "18K",
    details: ["Trilogy Design", "1.0 Total Carats", "Symbolic Meaning", "Handcrafted"]
  },
  {
    id: "diamond-ring-005",
    ...
    weight: "7.2 grams",
    purity: "18K",
    details: ["Vintage Style", "Filigree Work", "Antique Look", "Unique Design"]
  },
  {
    id: "diamond-ring-006",
    ...
    weight: "5.8 grams",
    purity: "18K",
    details: ["Pave Setting", "Continuous Sparkle", "Eternity Style", "Dainty"]
  },
  {
    id: "diamond-ring-007",
    ...
    weight: "6.5 grams",
    purity: "18K",
    details: ["Oval Cut", "Elongated Shape", "Elegant", "Timeless"]
  },
  {
    id: "diamond-ring-008",
    ...
    weight: "7.8 grams",
    purity: "18K",
    details: ["Emerald Cut", "Step Facets", "Art Deco Style", "Premium"]
  },
  {
    id: "diamond-ring-009",
    ...
    weight: "6.8 grams",
    purity: "18K",
    details: ["Pear Shape", "Teardrop Design", "Unique", "Graceful"]
  },
  {
    id: "diamond-ring-010",
    ...
    weight: "5.5 grams",
    purity: "18K",
    details: ["Full Eternity", "All Around Stones", "Stackable", "Classic"]
  }
];

export default function DiamondRingDetailPage() {
  const params = useParams();
  const { addToCart } = useCart();
  const [quantity, setQuantity] = useState(1);

  const product = diamondRings.find((r) => r.id === params.id);
    ...
    return (
      <main className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-600 mb-6">The diamond ring you're looking for doesn't exist.</p>
          <Link href="/products/diamond-rings" className="text-[#E92247] hover:underline">← Back to Diamond Rings</Link>
        </div>
      </main>
    );
  }
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <ChevronRight className="w-4 h-4" />
            <Link href="/products/diamond-rings" className="hover:text-[#E92247] transition-colors">Diamond Rings</Link>
            <ChevronRight className="w-4 h-4" />
