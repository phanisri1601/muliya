...
export default function PendantsPage() {
  ...
  const [filteredPendants, setFilteredPendants] = useState(pendants);
  ...
  const handlePriceRangeChange = (range: string) => {
    ...
    const filtered = pendants.filter(pendant => {
  ...
  const handleDiscountChange = (discount: string) => {
    const filtered = pendants.filter(pendant => pendant.originalPrice !== undefined);
    setFilteredPendants(filtered);
  };
