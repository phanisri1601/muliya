...
const diamondEarrings: Product[] = [
  {
    ...
    weight: "4.2 grams",
    purity: "18K",
    details: ["VS Clarity Diamonds", "Classic Round Cut", "Secure Screw Back", "Everyday Elegance"]
  },
  {
    ...
    weight: "5.5 grams",
    purity: "18K",
    details: ["Drop Design", "Brilliant Sparkle", "Elegant Movement", "Party Wear"]
  },
  {
    ...
    weight: "6.8 grams",
    purity: "18K",
    details: ["Pave Setting", "Continuous Sparkle", "Classic Hoop", "Versatile"]
  },
  {
    ...
    weight: "8.5 grams",
    purity: "18K",
    details: ["Chandelier Style", "Cascading Design", "Statement Piece", "Grand Occasions"]
  },
  {
    ...
    weight: "5.2 grams",
    purity: "18K",
    details: ["Cluster Design", "Multiple Stones", "High Sparkle", "Floral Pattern"]
  },
  {
    ...
    weight: "12.5 grams",
    purity: "18K",
    details: ["Traditional Jhumka", "Cultural Design", "Festive Wear", "Indian Style"]
  },
  {
    ...
    weight: "5.8 grams",
    purity: "18K",
    details: ["Large Solitaire", "Premium Grade", "Classic Elegance", "Timeless"]
  },
  {
    ...
    weight: "7.2 grams",
    purity: "18K",
    details: ["Modern Design", "Dangle Style", "Contemporary", "Trendy"]
  },
  {
    ...
    weight: "6.2 grams",
    purity: "18K",
    details: ["Halo Setting", "Center Stone", "Accent Diamonds", "Enhanced Sparkle"]
  },
  {
    ...
    weight: "7.8 grams",
    purity: "18K",
    details: ["Tennis Style", "Continuous Line", "Uniform Size", "Elegant"]
  }
];

export default function DiamondEarringDetailPage() {
  const params = useParams();
  const { addToCart } = useCart();
  const [quantity, setQuantity] = useState(1);

  const product = diamondEarrings.find((e) => e.id === params.id);
    ...
    return (
      <main className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-600 mb-6">The diamond earring you're looking for doesn't exist.</p>
          <Link href="/products/diamond-earrings" className="text-[#E92247] hover:underline">← Back to Diamond Earrings</Link>
        </div>
      </main>
    );
  }
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <ChevronRight className="w-4 h-4" />
            <Link href="/products/diamond-earrings" className="hover:text-[#E92247] transition-colors">Diamond Earrings</Link>
            <ChevronRight className="w-4 h-4" />
